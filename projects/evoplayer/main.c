...
static void prospero_settings_save(void)
{
    ...
    fprintf(
        ...
        prospero_auto_subtitles_enabled,
        show_debug_overlay,
        evo_sort_folders_first   /* EVO: appended last, see load() */
    );
...
static void prospero_settings_load(void)
{
    ...
    if (file) {
        ...
        /* Accept 5 (pre-EVO file) or 6. Anything less is corrupt. */
        if (values_read < 5) {
            loaded_profile = 0;
            loaded_resume = 1;
            loaded_view = 0;
...
void draw_settings_screen(uint32_t *fb) {
    ...
    const int settings_count = 7;   /* EVO: +FOLDERS FIRST */
...
static void rr_icon(uint32_t *fb,int x,int y,int idx){
    switch(idx){case 0:rr_img(fb,x,y,EVO_ICON_BROWSE_USB_W,EVO_ICON_BROWSE_USB_H,EVO_ICON_BROWSE_USB);break;case 1:rr_img(fb,x,y,EVO_ICON_RECENT_FILES_W,EVO_ICON_RECENT_FILES_H,EVO_ICON_RECENT_FILES);break;case 2:rr_img(fb,x,y,EVO_ICON_FAVORITES_W,EVO_ICON_FAVORITES_H,EVO_ICON_FAVORITES);break;case 3:rr_img(fb,x,y,EVO_ICON_SETTINGS_W,EVO_ICON_SETTINGS_H,EVO_ICON_SETTINGS);break;case 4:rr_img(fb,x,y,EVO_ICON_DEVELOPER_TOOLS_W,EVO_ICON_DEVELOPER_TOOLS_H,EVO_ICON_DEVELOPER_TOOLS);break;case 5:rr_img(fb,x,y,EVO_ICON_ABOUT_SUPPORT_W,EVO_ICON_ABOUT_SUPPORT_H,EVO_ICON_ABOUT_SUPPORT);break;case 6:rr_img(fb,x,y,EVO_ICON_CHEVRON_W,EVO_ICON_CHEVRON_H,EVO_ICON_CHEVRON);break;}}
static void rr_control(
    uint32_t *fb,
    int x,
    int y,
...
void draw_menu_linear(uint32_t *fb, int selected) {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        /* EVO: drawn rather than blitted - see EVO_CARD_* above. */
        ui_round_asset(fb,
                       row_x + EVO_CARD_INSET,
                       row_y + EVO_CARD_INSET,
                       RR_CARD_NORMAL_W - 2 * EVO_CARD_INSET,
                       RR_CARD_NORMAL_H - 2 * EVO_CARD_INSET,
                       EVO_CARD_RADIUS,
                       EVO_CARD_NORMAL_FILL,
                       EVO_CARD_NORMAL_STROKE,
                       EVO_CARD_NORMAL_GLOW);
    }
    ...
    ui_round_asset(fb,
                   mx + EVO_CARD_INSET,
                   selected_draw_y + EVO_CARD_INSET,
                   RR_CARD_SELECTED_W - 2 * EVO_CARD_INSET,
                   RR_CARD_SELECTED_H - 2 * EVO_CARD_INSET,
                   EVO_CARD_RADIUS,
                   EVO_CARD_SELECTED_FILL,
                   EVO_CARD_SELECTED_STROKE,
                   EVO_CARD_SELECTED_GLOW);
