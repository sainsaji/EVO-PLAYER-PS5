 ...
 *
 * Off unless -DEVO_VO_DEBUG=1 (a manual dev flag; no shipping build sets it).
 * Logs screen transitions and one line a second while the player is up,
 * nothing per frame, into /mnt/usb0/evo.log alongside everything else.
 * ------------------------------------------------------------------------ */
#ifndef EVO_VO_DEBUG
