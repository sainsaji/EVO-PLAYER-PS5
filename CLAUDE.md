...
| [memory-budget.md](docs/hardware/memory-budget.md) | **The title's memory, measured 2026-09-25: direct 12 GB, flexible 448 MB.** Read this before saying EVO is memory-limited — the "~180 MB ceiling" quoted in older notes was a bad inference and is retracted |
